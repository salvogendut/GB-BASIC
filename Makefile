...
raws:
	...
	DATA_LOC=0x6800       bash tools/build_app.sh apps/basrun build/BASRUN.RAW
...
raws-msx:
	...
	APPDEFS=-DGB_MSX2       DATA_LOC=0x6800 bash tools/build_app.sh apps/basrun build/msx/BASRUN.RAW
